              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 sm:gap-3 text-xs sm:text-sm text-slate-600 dark:text-slate-400 mb-2">
                      ...
                      <button
                        ...
                        className={`p-2 rounded-lg transition-colors ${
                          strategy.feedback_rating === "up"
                            ...
                            : "bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-green-100 dark:hover:bg-green-900"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`p-2 rounded-lg transition-colors ${
                          strategy.feedback_rating === "down"
                            ...
                            : "bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-red-100 dark:hover:bg-red-900"
                        }`}
                      >
                    ...
                    >
                      <div className="flex flex-col space-y-1">
                        <button
                          ...
                          className="w-full flex items-center justify-start gap-2 px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-primary-50 dark:hover:bg-primary-900/40 hover:text-primary-600 dark:hover:text-primary-400 rounded-lg transition-colors"
                        >
