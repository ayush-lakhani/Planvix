...
export default function ContentCalendar() {
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] bg-slate-50 dark:bg-[#0d0e12] text-slate-900 dark:text-white p-4 sm:p-6 relative overflow-hidden font-sans transition-colors duration-300">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row gap-4 sm:gap-6 h-[calc(100vh-8rem)] relative z-10">
        ...
        {/* Main Calendar Area */}
        <div className="flex-1 bg-white/60 dark:bg-[#121318]/60 backdrop-blur-xl border border-slate-200 dark:border-white/5 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl dark:shadow-[0_8px_32px_rgba(0,0,0,0.5)] flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4 sm:mb-6">
            ...
            <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-auto">
              <div className="flex bg-white dark:bg-[#18191e] rounded-xl border border-slate-200 dark:border-white/5 p-1">
              ...
              <button className="group relative bg-white dark:bg-[#18191e] border border-slate-200 dark:border-white/5 hover:border-indigo-300 dark:hover:border-[#6200EE]/50 px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl transition-all duration-300 overflow-hidden flex items-center gap-1 sm:gap-2">
          ...
          <div className="flex-1 flex flex-col min-h-0 ring-1 ring-slate-200 dark:ring-white/5 rounded-2xl overflow-hidden bg-slate-100 dark:bg-[#000000]/20">
            ...
            <div className="flex border-b border-slate-200 dark:border-white/5 bg-slate-50/50 dark:bg-[#1e1f25]/50 backdrop-blur-md shrink-0">
            ...
            <div className="flex-1 overflow-x-auto overflow-y-hidden">
              <div className="grid grid-cols-7 min-w-[280px] sm:min-w-0 h-full auto-rows-fr gap-[1px] bg-slate-200 dark:bg-white/5">
                ...
                {Array.from({ length: startDay }).map((_, i) => (
                  <div key={`empty-${i}`} className="bg-slate-50/80 dark:bg-[#121318]/80 backdrop-blur-md p-1 sm:p-2 min-h-[60px] sm:min-h-0"></div>
                ))}
                ...
                {Array.from({ length: daysInMonth }).map((_, i) => {
                  ...
                  return (
                    <div
                      ...
                      className={`bg-white/80 dark:bg-[#0d0e12]/80 backdrop-blur-xl p-1 sm:p-2 md:p-3 relative cursor-pointer transition-all duration-300 hover:bg-slate-50 dark:hover:bg-[#18191e] min-h-[60px] sm:min-h-0 ${isSelected ? 'ring-2 ring-inset ring-indigo-500 dark:ring-[#6200EE] bg-indigo-50 dark:bg-[#1e1f25]' : ''}`}
                    >
        ...
        <div className="w-full lg:w-80 xl:w-96 bg-white/60 dark:bg-[#18191e]/60 backdrop-blur-2xl border border-slate-200 dark:border-white/5 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl dark:shadow-[0_0_40px_rgba(0,0,0,0.6)] flex flex-col relative overflow-hidden">
           ...
           <div className="space-y-4 sm:space-y-6 flex-1 overflow-y-auto pr-1 sm:pr-2 custom-scrollbar">
              ...
              <div>
                 ...
                 {contentMap[selectedDay] ? (
                   ...
                   <div className="text-xs sm:text-sm text-slate-500 dark:text-gray-500 bg-slate-50 dark:bg-[#121318] p-3 sm:p-4 rounded-2xl border border-slate-200 dark:border-white/5 text-center">No posts scheduled.</div>
                 )}
              </div>
              ...
              <div>
                 ...
                 <div className="space-y-3 sm:space-y-4">
                   <div className="flex items-center gap-3 sm:gap-4">
                      <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-slate-50 dark:bg-[#121318] border border-emerald-500/30 flex items-center justify-center flex-shrink-0">
                   ...
                   <div className="flex items-center gap-3 sm:gap-4 relative">
                      ...
                      <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-slate-50 dark:bg-[#121318] border border-indigo-300 dark:border-[#a68cff]/50 flex items-center justify-center flex-shrink-0 relative">
